...
9. 每日目标：热量目标、蛋白质目标、每周训练次数、目标体重，首页进度条展示
10. 训练计划复制：一键克隆训练日含全部动作设置
...
- server/ 后端服务
  - src/config 配置与数据库连接
  - src/routes API 路由（health/auth/users/body/exercises/plans/sessions/diet/checkins/home/stats/export）
